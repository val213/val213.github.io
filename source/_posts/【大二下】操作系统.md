...
- A data structure in kernel that contains information about the process needed to manage a particular process
...
<!-- ![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-39.png?raw=true?raw=true) -->
...
##### 混合实现
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-41.png?raw=true)
#### ⭐进程和线程比较
...
- **信号量的使用**
    ...
    ![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-47.png?raw=true)
- 信号量同步的缺点
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-50.png?raw=true)
#### 读者写者问题
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-51.png?raw=true)
##### 变体
...
- Threads
    - User-level threads
        ...
        ![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-42.png?raw=true)
    - Kernel-level threads
        - 内核级线程调度由内核调度器选取，线程是调度的最小单位，可以在不同进程的线程之间调度
        ![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-43.png?raw=true)
## chapter 6 Deadlocks
### 资源
#### 分类
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-123.png?raw=true)
- 避免死锁的算法是基于安全状态的。
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-126.png?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-128.png?raw=true)
###### 银行家算法的问题
...
- 需要硬件支持：为 CPU 配备两个特殊硬件寄存器：base and limit registers
    - base 寄存器：地址空间的起始位置
    - limit 寄存器：地址空间的大小限制
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-52.png?raw=true)
...
- 如果大多数进程在运行时会增长怎么办？
    ...
    - 但换入和换出成本太高
    - 允许增长，预留一片区域来扩展
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-56.png?raw=true)
#### Compaction 压缩
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-58.png?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-59.png?raw=true)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-60.png?raw=true)
#### Page tables
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-61.png?raw=true)
- 用来从虚页映射到页帧(主存中)
...
- 物理地址分为
    ...
    - 页面偏移量
    - 页表的作用是将虚拟页面映射到页框上。
    ![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-62.png?raw=true)
    ![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-63.png?raw=true)
- 将 VPN（虚页号）映射到 PFN
    - VPN 是确定 PFN 的表的索引
...
- 页表项中具体还有其他的字段，如下图：
    ...
    ![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-64.png?raw=true)
- 问题
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-65.png?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-67.png?raw=true)
...
![alt text](<(58MY]QZJP$I`%Q(0DZ80WP.png>)
![alt text](<)7JJK_3ALVY}W9[BX`7%MXJ.png>)
###### 线性倒排页表
- 优点
    - 大地址空间，小页表
- 缺点
...
- **NFU (Not Frequently Used)**：不经常使用算法，通过为每个页面维护一个计数器来记录页面被访问的频率，置换计数器值最小的页面。
...
- **Aging**：老化算法，是NFU的改进版，通过为每个页面维护一个移位寄存器来模拟LRU的效果，定期将寄存器右移，同时将访问位加到最左边，以此来近似页面的访问频率和时间。
...
- Local Replacement
- Global Replacement
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-73.png?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-76.png?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-79.png?raw=true)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-80.png?raw=true)
TLB：
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-81.png?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-85.png?raw=true)
- Advantages
    - 易于实现（仅需要起始扇区和文件长度）
    - 读取性能出色（适合顺序访问和直接访问）
- Disadvantages
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-83.png?raw=true)
...
- 把硬盘块中的 next 指针移到一个 `FAT(File Allocation Table)` 表中，FAT 是被存储在内存中的,以尽量减少磁盘寻道，但是空间开销可能很大
- 磁盘上每个块一个条目，按块号排序
- 每个条目包含“下一个”块的地址
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-87.png?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-89.png?raw=true)
- 优点
    - 快速查找和随机访问
    - 不受外部碎片的影响
...
- Solution3: Directory entries are fixed in length, pointer to file name in heap
    ...
    - 必须管理堆
    - 处理文件名时仍可能发生页面错误
    ![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-93.png?raw=true)
...
- 不要在目录中列出磁盘块地址，而是在一个小的数据结构中列出，i-node ➔ 硬链接
    ...
    ![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-95.png?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-97.png?raw=true)
...
- 块大：数据传输率大，空间利用率小
- 块小：数据传输率小，空间利用率大
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-98.png?raw=true)
...
- 使用位图：具有 n 个块的磁盘需要具有 n 位的位图
    ...
    ![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-100.png?raw=true)
- 位图与链表比较
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-103.png?raw=true)
###### fsck：目录级一致性检查
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-101.png?raw=true)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-102.png?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-104.png?raw=true)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-105.png?raw=true)
...
- 当前进程进入阻塞状态
- 使用中断驱动I/O将字符串写入打印机
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-106.png?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-107.png?raw=true)
    - (a) Code executed when print system call is made
    - (b) Interrupt service procedure
### I/O software layers
...
- 驱动程序可以为多个操作系统编写
- 每个驱动程序可以处理一种类型的设备
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-108.png?raw=true)
...
#### Device-Independent OS Software
- 设备驱动程序的统一接口
    - ![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-110.png?raw=true)
    - 在 Unix 中，设备被建模为特殊文件。
    - 通过使用系统调用（如 open()、read()、write()、close()、ioctl() 等）可以访问它们。
    - 每个设备都与一个文件名相关联。
    - 主设备号定位相应的驱动程序。
        - 次设备号（存储在 i 节点中）作为参数传递给驱动程序，以指定要读取或写入的具体设备单元。
        ![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-109.png?raw=true)
    - 文件的常用保护规则也适用于 I/O 设备
- 缓冲buffer
    - ![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-111.png?raw=true)
    - (a) 无缓冲输入
    - (b) 在用户空间缓冲
    - (c) 在内核缓冲，然后复制到用户空间
    - (d) 在内核双缓冲
    - ![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-112.png?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-115.png?raw=true)
### Disks
磁盘被分成`柱面(cylinders)`，每个柱面包含`磁道(tracks)`，每个磁道被分成了一些`扇区(sectors)`，扇区大小通常为 `512bytes`
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-113.png?raw=true)
#### 磁盘格式化
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-118.png?raw=true)
###### 柱面斜进
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-114.png?raw=true)
- 就是为了补偿寻道过程中盘片的旋转时间
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-119.png?raw=true)
#### 磁盘臂调度算法
##### 表现的指标
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-117.png?raw=true)
##### Elevator（电梯算法）
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-116.png?raw=true)


#### 错误处理
预留扇区来给坏扇区使用，当检测到有扇区损坏的时候，就把预留扇区映射到原来的坏扇区中。
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-120.png?raw=true)
...
14. 十进制虚拟地址，分别用4KB 页面和8KB 页面计算虚拟页号和偏移量：20000，32768，60000
    - 4KB和8KB，即是2^{12},2^{13}。分别去除题目给的三个十进制虚拟地址，商和余数就分别是虚拟块号和偏移量
