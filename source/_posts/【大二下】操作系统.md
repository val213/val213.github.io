...
21. 工作集时钟页面置换算法
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image/image-249.png?raw=true)
22. 一些置换算法
...
29. 一个UNIX系统使用4KB磁盘块和4字节磁盘地址。如果每个i节点中10个直接表项，一个间接表项，一个双重间接表项，一个三重间接表项，一个文件最大大小是多少？
    ...
    - ![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image/image-250.png?raw=true)
30. 打开inode，打开文件；
## chapter 6
