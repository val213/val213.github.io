...
# 编译器组成
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-255.png?raw=true)

# lexical analysis 词法分析 (scanner)

## RE
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-256.png?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-257.png?raw=true)

![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-258.png?raw=true)

![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-259.png?raw=true)



#### Minimizing Algorithm 
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-260.png?raw=true)

# Syntax Analysis 语法分析 (parsing)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-262.png?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-261.png?raw=true)

![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-263.png?raw=true)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-264.png?raw=true)

### RE vs CFG
CFG 中不能使用Kleene闭包，因为这样会导致无限递归。但是可以使用递归的产生式。

### Derivation 推导
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-265.png?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-266.png?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-267.png?raw=true)
## Derivations and Parse Trees
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-268.png?raw=true)
- A parse tree has
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-269.png?raw=true)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-270.png?raw=true)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-271.png?raw=true)
## ambiguity 二义性
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-273.png?raw=true)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-272.png?raw=true)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-274.png?raw=true)

### Left Recursion
什么是左递归，什么是右递归
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-275.png?raw=true)
#### Elimination of Left Recursion
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-276.png?raw=true)
### Left Factoring
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-277.png?raw=true)
## parsing algorithm
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-278.png?raw=true)
#### backtracking 回溯
BFS剪枝，时间和空间开销大。
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-280.png?raw=true)
例1：
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-279.png?raw=true)
例2：
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-305.png?raw=true)
典型的非LL(1)文法：
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-281.png?raw=true)
###### 构造递归下降分析器+LL1 parsing
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-282.png?raw=true)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-283.png?raw=true)

- 分析表
  - 一般的，根据FIRST集，分别填上能够推导出对应符号的式子；
  - 文法中可以推导出空集的非终止符的：就把follow集中的每一个元素和这个非终止符的对应的cell里填上推导出空的式子；

![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-295.png?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-285.png?raw=true)

- Parsing Table: 
  - top-down的分析表：选择产生式的规则
  - bottom-up的分析表：选择规约的产生式

![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-284.png?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-286.png?raw=true)

##### LR(0) parsing的问题：
- 无法处理shift-reduce冲突
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-287.png?raw=true)
- 无法处理reduce-reduce冲突
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-288.png?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-289.png?raw=true)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-290.png?raw=true)
基本思想：看当前的handle对应的非终止符号（产生式的左部）后面允许出现哪些终止符号
##### 判断是否为SLR(1)文法
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-306.png?raw=true)
满足以下条件的文法是SLR(1)文法：
1. 存在shift-reduce冲突
2. 冲突能够通过FOLLOW集解决
##### SLR分析存在的问题
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-294.png?raw=true)
也就是集合$\{a_1,a_2,...,a_m\}$和$FOLLOW\{B_n\}$的交集不为空，下一个输入的字符在此之中，那么就会出现冲突。

##### SLR分析表
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-302.png?raw=true)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-303.png?raw=true)
##### SLR分析栈
(正确：only state symbols at the top of the stack)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-304.png?raw=true)
#### LR(1) parsing
SLR能帮我们排除一些不可能的规约，但是不能保证所有的规约都是正确的。

![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-291.png?raw=true)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-292.png?raw=true)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-293.png?raw=true)
#### LALR parsing
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-309.png?raw=true)
...
- 显式地指明了语义规则的计算顺序。
### parse tree
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-307.png?raw=true)
### Dependency Graph
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-308.png?raw=true)
### 控制流SDT
...
### logical expression
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-311.png?raw=true)
### Control Flow Statements
- 三地址代码的基本结构是三地址指令，控制结构的三地址代码是基于基本结构的。

![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-310.png?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-296.png?raw=true)
- 代码生成中使用的函数
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-301.png?raw=true)

![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-298.png?raw=true)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-297.png?raw=true)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-299.png?raw=true)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-300.png?raw=true)
