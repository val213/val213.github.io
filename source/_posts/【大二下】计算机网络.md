...
# 第一章
## 电路交换网络和分组交换网络
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-239.png?raw=true)
### 电路交换网络
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-232.png?raw=true)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-233.png?raw=true)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-234.png?raw=true)
...
### 分组交换网络
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-235.png?raw=true)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-236.png?raw=true)


#### 虚电路网络和数据报网络
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-237.png?raw=true)
##### 数据报(datagram)网络
数据报(datagram) 的工作原理
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-238.png?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-217.png?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-245.png?raw=true)
### checksum
...
例如：
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-246.png?raw=true)
把取反之后的值放进 checksum 中。
在接收方中，把所有的 4 个 16 位的字(包括校验和)相加，如果没有出错的话就是全为 1，如果有一位为 0，就说明出错了
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-247.png?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-26.png?raw=true?raw=true)
### rdt2.0
#### sending side
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-27.png?raw=true?raw=true)
#### receiving side
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-28.png?raw=true?raw=true)
### rdt2.1
#### sender
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-29.png?raw=true?raw=true)
#### receiver
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-30.png?raw=true?raw=true)
### rdt2.2
#### sender
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-31.png?raw=true?raw=true)
#### receiver
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-32.png?raw=true?raw=true)
### rdt3.0
#### sender
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-34.png?raw=true?raw=true)
#### receiver
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-33.png?raw=true?raw=true)
由于分组序号总是在 0 与 1 之间交替，有时 rdt3.0 也被称为**比特交替协议(alternating-bit protocol）**
### 流水线rdt
流水线 RDT
在停等协议里，对信道的使用率极低
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-212.png?raw=true)
因此我们以流水线的方式——即在确认 ACK 抵达前就开始发送新的 packet
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-213.png?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-207.png?raw=true)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-209.png?raw=true)
- SR: swndow size≥1, rwndow size≥1；
同样是用窗口长度 N 来限制未完成、未被确认的 packet 数量。
不同的是 SR 的接收方会对失序的分组(即落在窗口内的非起始 packet)进行接收并缓存。
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-208.png?raw=true)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-211.png?raw=true)
## TCP
### 三次握手
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-214.png?raw=true)
### 往返时间的估计与超时
估计往返时间
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-248.png?raw=true)
### 超时重传
...
## 路由算法
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-22.png?raw=true?raw=true)
### LS：链路状态
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-20.png?raw=true?raw=true)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-21.png?raw=true?raw=true)
### DV：距离矢量
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-244.png?raw=true)
...
4. 数据位后面加上r位的冗余位，使得整个数据位串能够被G(x)整除
   ...
   ![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-13.png?raw=true?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-15.png?raw=true?raw=true)
##### CSMA/CD
...
加入碰撞检测之后，在检出碰撞后停止传输。
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-16.png?raw=true?raw=true)
...
# 物理层
# a day in the life of a web request
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-243.png?raw=true)
# 考试题型
- 选择题
- 填空题
- 判断题 
...
- p15
   - ![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-18.png?raw=true?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-19.png?raw=true?raw=true)
- (i)从A到左边的路由器:
...
- P3 Djisktra算法计算x到所有节点的最短路径。
   ...
   - ![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-23.png?raw=true?raw=true)
...
- P5 假设每个节点初始时知道到它的每个邻居的费用，考虑距离向量算法，并显示在节点z中的距离表表项（一次次迭代）
   ...
   - |节点|到x的距离|到y的距离|到z的距离|
      ...
      |z|2|4|0|
- P14 
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-24.png?raw=true?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-216.png?raw=true)
...
- P8 画出rdt3.0接收方的FSM
   ...
   ![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-25.png?raw=true?raw=true)
...
- P9 考虑图 2-12，其中有一个机构的网络和因特网相连(15Mbps)。假定对象的平均长度为850k比特，从这个机构网的浏览器到初始服务器的平均请求率是每秒16个请求。还假定从接入链路的因特网一侧的路由器转发一个HTTP请求开始，到接收到其响应的平均时间是3秒(参见2.2.5节)。将总的平均响应时间建模为平均接入时延(即从因特网路由器到机构路由器的时延)和平均因特网时延之和。对于平均接入时延，使用 $\Delta/(1-\Delta \beta)$，式中$\Delta$是跨越接入链路发送一个对象的平均时间，$\beta$是对象对该接入链路的平均到达率。
   ...
   ![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-36.png?raw=true?raw=true)
   - a. 无缓存
...
- P25
   - ![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-37.png?raw=true?raw=true)
   - a. $R \cdot t_{prop}$
...
- P31 
   - ![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-38.png?raw=true?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-219.png?raw=true)
...
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-240.png?raw=true)
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-241.png?raw=true)

#### TCP拥塞控制
(2) ![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-218.png?raw=true)
...
#### 传输层
![alt text](https://github.com/val213/val213.github.io/blob/hexo_source/source/_posts/image-242.png?raw=true)
